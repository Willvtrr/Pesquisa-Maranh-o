...
// Ícones Inline para evitar bug de HMR do Turbopack
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      >
        ...
        <p className="text-sm md:text-base text-zinc-500 font-medium leading-relaxed max-w-md mb-12">
          Mapeamento de votos com precisão cirúrgica no Maranhão. Domine o cenário político com dados em tempo real e inteligência direta.
        </p>

        {/* Formulário de Acesso Compacto */}
        ...
        {/* Rodapé de Segurança Protetizado */}
