...
export const RankingCard = ({ 
  ...
  const colorStyles = {
    red: {
      ...
      icon: <AlertCircle size={14} className="text-zinc-300" />,
  ...
  return (
    <div className={cn(
      "bg-white rounded-[2.5rem] p-8 lg:p-10 border border-zinc-100 shadow-sm flex flex-col h-full",
      className
    )}>
      {/* Header */}
      <div className="mb-8">
            ...
            <div key={idx} className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="text-[10px] font-black text-zinc-300 uppercase tabular-nums">
                    #{idx + 1}
                  </span>
